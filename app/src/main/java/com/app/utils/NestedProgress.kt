...
import com.app.R
import com.app.constants.AppConstants.NestedProgress.ANIM_DURATION
import com.app.constants.AppConstants.NestedProgress.CIRCLE_RADIUS
import com.app.constants.AppConstants.NestedProgress.COLOR_INNER
import com.app.constants.AppConstants.NestedProgress.COLOR_OUTER
import com.app.constants.AppConstants.NestedProgress.DESIRED_WH
import com.app.constants.AppConstants.NestedProgress.INNER_ANIM_INTERPOLATOR
import com.app.constants.AppConstants.NestedProgress.INNER_LOADER_LENGTH
import com.app.constants.AppConstants.NestedProgress.INNER_STROKE_WIDTH
import com.app.constants.AppConstants.NestedProgress.MAX_B_CIRCLES
import com.app.constants.AppConstants.NestedProgress.MAX_STROKE
import com.app.constants.AppConstants.NestedProgress.MAX_TOTAL_STROKE
import com.app.constants.AppConstants.NestedProgress.MID_POINT
import com.app.constants.AppConstants.NestedProgress.MIN_B_CIRCLES
import com.app.constants.AppConstants.NestedProgress.MIN_STOKE
import com.app.constants.AppConstants.NestedProgress.OUTER_ANIM_INTERPOLATOR
import com.app.constants.AppConstants.NestedProgress.OUTER_LOADER_LENGTH
import com.app.constants.AppConstants.NestedProgress.OUTER_STROKE_WIDTH
import com.app.constants.AppConstants.NestedProgress.SPACE_BETWEEN_CIRCLES
import com.app.constants.AppConstants.NestedProgress.START_POINT
import com.app.extention.toDP
...
class NestedProgress @JvmOverloads constructor(
    ...
    @ColorInt
    var innerLoaderColor: Int = COLOR_INNER

    @ColorInt
    var outerLoaderColor: Int = COLOR_OUTER
     ...
     */
    @Dimension
    var innerLoaderStrokeWidth: Float = INNER_STROKE_WIDTH.toDP
        set(value) {
            field =
                if (value > MAX_STROKE.toDP || value < MIN_STOKE.toDP) throw IllegalArgumentException(
                    resources.getString(
    ...
    @Dimension
    var outerLoaderStrokeWidth: Float = OUTER_STROKE_WIDTH.toDP
        set(value) {
            field =
                if (value > MAX_STROKE.toDP || value < MIN_STOKE.toDP) throw IllegalArgumentException(
                    resources.getString(
     ...
     */
    @Dimension
    var spaceBetweenCircles = SPACE_BETWEEN_CIRCLES.toDP
        set(value) {
            field =
                if (value > MAX_B_CIRCLES.toDP || value < MIN_B_CIRCLES.toDP) throw IllegalArgumentException(
                    resources.getString(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val desired = DESIRED_WH.toDP.roundToInt()
        ...
        val expansion = MAX_TOTAL_STROKE.toDP - highStroke
